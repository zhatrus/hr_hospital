...
#### 1. Абстрактна модель "Особа" (abstract.person) та наслідування (1.1, 1.2)
...
- Країна громадянства та мова спілкування
- Зв'язок One2many з контактними особами

#### 4. Нова модель Contact Person (hr.hospital.contact.person)

Модель `hr.hospital.contact.person` тепер наслідує від `abstract.person`.

**Специфічні поля:**
- `relationship` - Тип відносин (подружжя, батьки, діти, друзі тощо)
- `is_emergency_contact` - Чи є екстреним контактом
- `notes` - Додаткові примітки
- `patient_id` - Зв'язок з пацієнтом (Many2one)
...
- Різні типи відносин
- Архівування старих контактів
- Валідація контактних даних (успадкована від abstract.person)

**Views:**
- Tree View з основною інформацією
- Form View з трьома групами полів
- Search View з фільтрами та групуванням
- Інтеграція з формою пацієнта (нова вкладка "Contact Persons")

**Demo дані:**
- 5 записів контактних осіб для різних пацієнтів
- Різні типи відносин
- Екстрені та звичайні контакти
...
- Повне ім'я відображається у заголовку форми
- Додано нову вкладку "Contact Persons" для управління контактними особами

**Contact Person Form View:**
- Відображення аватара контактної особи
- Три групи полів: Personal, Contact та Relationship Information
- Поле для приміток

**Tree Views:**
- Замінено поле `name` на `full_name` у всіх списках

#### 6. Оновлення Demo даних
...
- Додано 5 контактних осіб з різними типами відносин
