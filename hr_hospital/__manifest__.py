{
    ...
    'category': 'Healthcare',
    'summary': (
        'Професійна система управління медичним закладом з повною '
...
Повнофункціональна система управління лікарнею для Odoo 17 з повною
українською локалізацією.

🏥 Основні можливості:
----------------------
* **Управління пацієнтами**: повний облік з історією,
  контактними особами, групами крові, алергіями
* **База лікарів**: спеціалізації, ліцензії, графіки роботи,
  менторство інтернів, рейтинги
* **Візити та діагнози**: планування, множинні діагнози, рекомендації,
  вартість послуг
* **Класифікатор хвороб**: ієрархічна структура з кодами МКХ-10,
  ступенями небезпеки
* **Звіти та аналітика**: pivot-таблиці, графіки, експорт у JSON/CSV
* **Безпека**: 5 рівнів доступу (пацієнт, інтерн, лікар, менеджер,
  адміністратор)
* **Візарди**: масове перепризначення лікарів, перенесення візитів,
  автозаповнення розкладу
...
---------------------------
Повністю перекладений інтерфейс, повідомлення про помилки, підказки
та всі елементи системи.
